<template>
  <m-app>
    <m-app-bar @click.native="log" color="pink-400" font-color="white" size="md" :elevation="2">
      <m-button shape="circle" variety="flat" @click="drawer=true">
